...
The `Button` component also offers support for CSS pseudo-classes, such as `_hover`, `_focus`, `_active`, and `_disabled`. With these pseudo-classes, you can define how the `Button` should look and behave under certain states or user interactions.
